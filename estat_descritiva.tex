...
25    & 5                 & 0    & São Paulo      & Administração & 5000          \\ \hline
35    & 7                 & 1    & Rio de Janeiro & Farmácia          & 10000         \\ \hline
40    & 15                & 1    & Rio de Janeiro & Administração & 6000          \\ \hline
45    & 25                & 1    & Rio de Janeiro & Farmácia          & 7500          \\ \hline
22    & 1                 & 0    & São Paulo      & Farmácia          & 1740          \\ \hline
34    & 7                 & 0    & Rio de Janeiro & Farmácia          & 7000          \\ \hline
56    & 25                & 1    & São Paulo      & Administração & 6500          \\ \hline
19    & 0                 & 1    & Rio de Janeiro & Administração & 1990          \\ \hline
29    & 9                 & 0    & São Paulo      & Administração & 8000          \\ \hline
\end{tabular}
\end{adjustbox}
\end{table}
...
\begin{frame}{Tabela de frequência com divisão em classes} 
   \begin{exemplo}
        Pense na construção uma tabela de frequência para a variável \textit{Idade} da base de dados adotada no curso.
    \end{exemplo}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{figures/grafico_barras.png}
...
\begin{frame}{Gráficos - Exemplos a não serem seguidos}
    \begin{figure}
        \centering
        \includegraphics[width=0.3\linewidth]{figures/lie_7.jpeg}
    \end{figure}
\end{frame}
...
\begin{frame}{Média X Mediana}
    No caso do slide anterior, o salário médio é igual a $R\$ 711,20$. No entanto, esse valor não representa, de forma adequada, os salários mais
...
\begin{frame}{Escores padronizados}
    Suponhamos que tenha sido feito um estudo visando entender o desempenho dos alunos do curso de Administração no curso de Cálculo em comparação com o curso de Estatística. 
    \pause
    \vspace{5px}
